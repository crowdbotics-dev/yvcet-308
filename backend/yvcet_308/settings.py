"""
Django settings for yvcet_308 project.
...
WSGI_APPLICATION = 'yvcet_308.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "yvcet_308 API",
    "DESCRIPTION": "API documentation for yvcet_308 App",
    "VERSION": "v1",
}
